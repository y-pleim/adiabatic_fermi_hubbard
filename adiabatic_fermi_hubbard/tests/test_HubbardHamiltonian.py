...
def test_str():
    ...
    assert ham1.__str__() == test_string
...
def test_jw_hamiltonian():
    ...
    # second pauli op has rearrangement of last six Pauli strings
    test_pauli_op_2 = SparsePauliOp(
        [
            "IYZY",
            "IXZX",
            "YZYI",
...
#    anni_3 = FermionicOp({"-_3": 1.0}, num_spin_orbitals=4)
#
#    copy = fermi_hubbard_test.second_q_op()
#
