...
class HubbardHamiltonian():
    ...
    def __init__(self, lattice:Lattice, t:float=1.0, U:float=1.0):
        ...
        for i in range(2*n): #make all FermionicOp creation/annihilation operators for 2*n spin orbitals
            label = str(i)
        ...
        # adds hopping between final and initial sites if lattice has pbc
